...
import 'package:sachin_s_application1/presentation/confirmation_dialog/confirmation_dialog.dart';
import 'package:sachin_s_application1/presentation/filter_bottomsheet/filter_bottomsheet.dart';
import 'package:sachin_s_application1/presentation/apply_job_popup_dialog/apply_job_popup_dialog.dart';
import 'package:sachin_s_application1/presentation/logout_popup_dialog/logout_popup_dialog.dart';
...
class AppNavigationScreen extends StatelessWidget {
  ...
  onTapJobDetails(BuildContext context) {
    NavigatorService.pushNamed(
  ...
  onTapSavedDetailJob(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.savedDetailJobScreen,
    );
  }
  ...
  onTapAppliedJob(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.appliedJobScreen,
    );
  }

  onTapNotificationsGeneral(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.notificationsGeneralScreen,
    );
  }

  onTapNotificationsMyProposals(BuildContext context) {
    NavigatorService.pushNamed(
