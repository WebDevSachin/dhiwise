...
import 'package:sachin_s_application1/presentation/select_a_country_screen/models/select_a_country_model.dart';
...
class SelectACountryBloc
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
        frameOneController: TextEditingController(), radioGroup: ""));
    emit(state.copyWith(
